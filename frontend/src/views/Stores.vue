          ...
          <div class="map-section">
            <div class="map-container">
              <div class="map-placeholder">
                <el-icon size="60" color="var(--text-light)"
                  ><Location
                /></el-icon>
                <p>地图加载中...</p>
              ...
              >
                ...
                <div class="store-image">
                  ...
                  <div class="store-badges">
                    <span v-if="store.recommended" class="badge recommended"
                      >推荐</span
                    >
                    <span v-if="store.discount" class="badge discount"
                      >{{ store.discount }}折</span
                    >
                  </div>
                </div>
                  ...
                  <div class="store-footer">
                    <div class="price-range">
                      ...
                      <span class="price-value"
                        >¥{{ store.priceRange.min }}-{{
                          store.priceRange.max
                        }}</span
                      >
                    </div>
  ...
  setup() {
    ...
    const stores = ref([
      {
        ...
        discount: null,
        description:
          "专业的汽车美容服务，拥有10年经验的技师团队，使用进口清洁用品，为您的爱车提供最优质的服务。",
        serviceDetails: [
          { name: "基础洗车", price: 30 },
          { name: "精洗服务", price: 68 },
          { name: "内饰清洁", price: 88 },
      ...
      },
      {
        ...
        discount: null,
        description:
          "采用环保清洁技术，无污染排放，保护环境的同时为您的爱车提供优质服务。",
        serviceDetails: [
          { name: "环保洗车", price: 45 },
          { name: "蒸汽清洁", price: 78 },
          { name: "无水洗车", price: 55 },
    ...
    const filteredStores = computed(() => {
      ...
      if (filters.value.status) {
        result = result.filter(
          (store) => store.status === filters.value.status,
        );
      }
      ...
      if (filters.value.serviceType) {
        ...
        result = result.filter((store) => store.services.includes(serviceName));
      }

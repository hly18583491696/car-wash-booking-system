          ...
          <div class="profile-sidebar">
            <div class="user-card">
              <div class="user-avatar">
                <AvatarUploader :src="userInfo.avatar" @success="onAvatarSuccess" />
              </div>
              <div class="user-info">
            ...
            <div v-show="activeTab === 'preferences'" class="content-section">
              ...
              <el-form :model="preferences" label-width="120px">
                ...
                <el-form-item label="默认车辆">
                  <el-select
                    v-model="preferences.defaultVehicle"
                    placeholder="选择默认车辆"
                  >
                    <el-option
                      v-for="vehicle in vehicles"
...
export default {
  ...
  setup() {
      ...
      try {
        ...
        if (currentVehicle.value) {
          const index = vehicles.value.findIndex(
            (v) => v.id === currentVehicle.value.id,
          );
          if (index !== -1) {
    ...
    const onAvatarSuccess = (url) => { if (url) userInfo.value.avatar = url }
    return {
      onAvatarSuccess,
      activeTab,
      editMode,

        ...
        <el-card class="time-card">
          ...
          <div class="format-examples">
            <p>
              <strong>标准格式:</strong>
              {{
                TimeUtils.formatServerTime(currentTime, "YYYY-MM-DD HH:mm:ss")
              }}
            </p>
            <p>
              <strong>日期格式:</strong>
              {{ TimeUtils.formatDate(currentTime, "YYYY年MM月DD日") }}
            </p>
            <p>
              <strong>时间格式:</strong>
              {{ TimeUtils.formatServerTime(currentTime, "HH:mm:ss") }}
            </p>
            <p>
              <strong>ISO格式:</strong> {{ TimeUtils.formatToISO(currentTime) }}
            </p>
          </div>
        </el-card>
      </div>

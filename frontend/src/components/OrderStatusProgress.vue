  ...
  <div class="order-status-progress">
    ...
    <div class="status-header">
      <div class="status-info">
        ...
        <span
          v-if="order.progress && order.status === 'in_progress'"
          class="progress-text"
        >
          {{ order.progress }}%
        </span>
    ...
    <div class="progress-section">
      ...
      >
        <el-step title="订单提交" :icon="DocumentAdd">
          <template #description>
            <span class="step-time">{{
              formatStepTime(order.createTime)
            }}</span>
          </template>
        </el-step>
        <el-step title="确认预约" :icon="Select">
          <template #description>
            <span class="step-time">{{
              formatStepTime(order.confirmTime)
            }}</span>
          </template>
        </el-step>
        ...
        <el-step title="服务完成" :icon="CircleCheck">
          <template #description>
            <span class="step-time">{{
              formatStepTime(order.completeTime)
            }}</span>
          </template>
        </el-step>
      </el-steps>
      ...
      <!-- 详细进度条（处理中状态） -->
      <div
        v-if="order.status === 'in_progress' && order.progress !== undefined"
